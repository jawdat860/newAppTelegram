...
import ServicesFa from "../Favourite/ServicesFa";
import ServicesDisFa from "../Favourite/ServicesDisFa";
    ...
    >
      ...
      >
        ...
        <div className="flex items-center">
          ...
          >
            <ServicesFa numberOfCartItems={numberOfCartItems} thems={thems} />
            {numberOfCartItems > 0 && (
              <span
        ...
        >
          ...
          >
            ...
            {numberOfCartItem > 0 && (
              <div
                className={` ${
                  thems === "light" ? "text-[#3d3d3d] bg-white border-[#acacac]" : "bg-[#34495e] border-white"

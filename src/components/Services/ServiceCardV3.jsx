...
export default function ServiceCardV3({
  service,
  onClick,
  loading,
  titleLoad,
  ...
  return (
    <div
      ...
      className={`relative text-black items-center mb-[10px] flex gap-[5px]   ${
        thems === "light"
          ? "bg-[#f5f5f5] text-black"
          : "bg-[#34495e] text-white"
      }  p-[10px]  rounded-[22px] shadow-lg transition-transform transform hover:scale-105 duration-300 cursor-pointer w-full`}
    ...
    >
      ...
      <div
        ...
        className={`relative  w-full flex flex-[1] rounded-[20px] min-h-[150px] min-w-[100px]`} onClick={onClick}
        aria-label={`${service.title} image`}
      >
        {/* the image div */}        
          
          <div id="genn-ServiceCardcontainer-img-lebel-block" className="genn-ServiceCardcontainer-img-lebel-block text-[${}]">
            <div id="genn-ServiceCardcontainer-img-lebel-1" className="genn-ServiceCardcontainer-img-lebel-1 bg-LabelNewBg text-LabelNewText">New</div>
            <div id="genn-ServiceCardcontainer-img-lebel-2" className="genn-ServiceCardcontainer-img-lebel-2">-10%</div>
          </div>
      ...
      >
        ...
        <div className=" p-[6px] pb-[0] flex flex-col flex-[1] ">
          <div onClick={onClick} className=" ">
            <h1 className="text-[0.9rem]  border-b-[2px] pb-[10px] capitalize leading-[15px] sm:text-lg font-bold">
              {service.title}{" "}
              <span className="font-normal lowercase text-[12px]">
                {" "}
        ...
        >
            ...
            <div className="text-center text-[10px] " onClick={onClick}>
              ...
              {quantity === 0 ? (
                <div className="flex flex-col items-end">
                  <span className="  line-through text-[12px] font-[400] leading-[1] text-[#aaa]">
          ...
          <div className="aaaaaa3 overflow-hidden mr-[5px] min-w-[19px] w-[20px] ">

  ...
  return (
    ...
    >
      <div
        ...
        className={`absolute h-[40px] w-[100%]   ${
          thems === "light" ? "bg-appColor" : "bg-[#223242]"
        } top-[-30px] rounded-t-[40px] `}
      ></div>
      ...
      {/* Categories List */}
      {
        <div
          ...
          className={`genn-Services-menu flex z-[1000] items-center top-0 h-16 sticky  ${

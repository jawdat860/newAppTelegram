...
const LickeModal = ({ numberOfCartItems, thems }) => {
  ...
  return (
    <>
        ...
        >
          <SlLike
            className={` ${
              numberOfCartItems > 0
                ? thems ==="light" 
                ? "genn-Product-like-active-ico"
                : "genn-Product-like-active-ico-dark"
                : thems === "light"
                ? "genn-Product-like-pasive-ico"
                : "genn-Product-like-pasive-ico-dark"
            }`}
          />
        </button>
      </div>
      ...
      {isLovePageOpen && (
        ...
        >
          <div
            id="genn-LickeModal-all"
            className={` ${
              thems === "light" ? "bg-[#eee]" : "bg-[#223242] text-white"
            } min-h-[100vh] text-black relative z-[11] `}
          >
            <div
              id="genn-LickeModal-title"
              className="relative items-center m-auto py-[20px] px-[27px] max-w-[360px] leading-[1] text-[#8ba2be] font-bold text-center text-[20px] "
            >
            ...
            {ctxCart.itemsFavourite.length > 0 && (
              <>
                <div
                  id="genn-LickeModal--container-cards"

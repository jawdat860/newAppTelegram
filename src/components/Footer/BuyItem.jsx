...
const BuyItem = (props) => {
  ...
  return (
    <li
      ...
      className={`p-[10px] relative text-black gap-[15px] mb-[5px] flex flex-row  ${props.thems === "light" ? "bg-white text-black" : "bg-[#4e6174] text-white "} rounded-[20px] shadow-lg transition-transform transform hover:scale-105 duration-300 cursor-pointer w-full`}
    >
      <div

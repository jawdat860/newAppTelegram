  ...
  return (
    ...
    >
      <div
        ...
        } py-[20px] pb-[0] px-[0px] rounded-lg shadow-xl flex flex-col`}
      >
        <div className="flex flex-col gap-[20px] justify-center mb-[20px] transition-opacity duration-300 ease-in-out transform translate-y-2">
          <div id="genn-CartModal-title" className="flex justify-center">
        ...
        <div
          id="genn-CartModal-block-kard"
          className={`p-[15px]  ${
            thems === "light" ? "bg-white" : "bg-[#34495e] text-white"
          } pb-[10px] border-t-[1px] border-black ssss`}
        >

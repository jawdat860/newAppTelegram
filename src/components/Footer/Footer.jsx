...
function Footer() {
  ...
  return (
    <div
      id="genn-Footer-all"
      className={` ${
        thems === "light" ? "genn-Footer-all bg-white" : "genn-Footer-all-dark bg-[#34495e]"
      ...
      >
        ...
        <div className="flex items-center">
          ...
          >
            ...
            {numberOfCartItems > 0 && (
              <span
                className={`genn-Product-like-active transition duration-800 ease flex justify-center items-center rounded-full w-[20px] h-[20px] text-[15px] absolute bottom-[-5px] left-[-5px] top-auto  bg-colorLikeIco `}
              >
                {numberOfCartItems}
              </span>
            )}
          ...
          >
            ...
            {numberOfCartDisItems > 0 && (
              <span
                ...
                className={`genn-Product-dislike-active text-[15px] w-[20px] h-[20px]  transition duration-800 ease flex justify-center items-center rounded-full bg-colorDisLikeIco absolute top-[-5px] right-[-5px] `}
              >
          ...
          <li
            ...
            className={`px-2 flex justify-center items-center bg-white border-[1px] border-[#017ebc] w-[44px] h-[44px] rounded-[44px] ml-[20px]
              ${thems === "light"
                ? "genn-Footer-ico-phone"
                : "genn-Footer-ico-phone-dark"}
              `}
          >
        ...
        >
          ...
          >
            <div
              ...
              className={`w-[44px] h-[44px] flex justify-center items-center top-[-5px] left-[-4px] p-[10px] rounded-[50px] 
                ${thems === "light"
                  ? "genn-Footer-shoppingCart"
                  : "genn-Footer-shoppingCart-dark"}
            ...
            {numberOfCartItem > 0 && (
              <div
                ...
                className={` ${
                  thems === "light"
                    ? "genn-Footer-shoppingCartForm "
                    : "genn-Footer-shoppingCartForm-dark "

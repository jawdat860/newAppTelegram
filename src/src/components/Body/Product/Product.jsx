    ...
    >
      ...
      >
        ...
        <div
          ...
          className="genn-ServiceCardcontainer-img-lebel-block "
        >
          <div
            id="genn-Product-img-lebel-1"
            className="genn-ServiceCardcontainer-img-lebel-1 bg-LabelNewBg text-LabelNewText"
          >
            New
          </div>
          <div
            id="genn-Product-img-lebel-2"
            className="genn-ServiceCardcontainer-img-lebel-2"
          >
            -10%
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          <div className="theCkeckDelete3 overflow-hidden mr-[5px] min-w-[19px] w-[20px] ">
